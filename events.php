                                                ...
                                                <div class="col-md-4 col-sm-6 col-lg-4">
                                                    <div class="event-box2">
                                                        <div class="event-thumb">
                                                            <a href="#" title=""><img src="<?php echo "admin/assets/img/events/".$upcomingEvent['Event_Image']?>" alt="event-img2-1.jpg"></a>
                                                        </div>
                                                        <div class="event-info">
                                                            <h4><a href="#" title=""><?php echo $upcomingEvent['Event_Title']?></a></h4>
                                                ...
                                                <div class="col-md-4 col-sm-6 col-lg-4">
                                                    <div class="event-box2">
                                                        <?php if($pastEvent["Event_Video"] != null) {?>
                                                            <div class="event-thumb">
                                                                <a href="#" title=""><video width="370" height="220" controls>
                                                                    <source src="<?php echo "admin/assets/video/events/".$pastEvent['Event_Video']?>" type = "video/mp4"></video>
                                                                </a>
                                                            </div>
                                                        <?php } else {?>
                                                            <div class="event-thumb">
                                                                <a href="#" title=""><img src="<?php echo "admin/assets/img/events/".$pastEvent['Event_Image']?>" alt="event-img2-1.jpg"></a>
                                                            </div>
                                                        <?php }?>
                                                        <div class="event-info">
                                                            <h4><a href="#" title=""><?php echo $pastEvent['Event_Title']?></a></h4>
