                        ...
                        <form id="add-blog-form" enctype="multipart/form-data">
                                ...
                                <div class="modal-body px-4">
                                    <div class="row mb-2">
                                        ...
                                        <div class="form-group">
                  							<textarea type="text" class="form-control" id="content" name="content" placeholder="Content Paragraph 1"></textarea>
                						</div>
                                        <div class="form-group">
                  							<textarea type="text" class="form-control" id="para_2" name="para_2" placeholder="Content Paragraph 2"></textarea>
                						</div>
                                        <div class="form-group">
                  							<textarea type="text" class="form-control" id="para_3" name="para_3" placeholder="Content Paragraph 3"></textarea>
                						</div>
                                        <div class="form-group">
                  							<textarea type="text" class="form-control" id="quote" name="quote" placeholder="Special Quote"></textarea>
                						</div>
                                        <div class="form-group">
