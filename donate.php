                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 col-lg-6">
                                <div class="hstry-desc">
                                    <p>The likeness of those who spend their wealth in the path of Allah is as the likeness of a Grain that sprouts seven spikes. In every spike, there is a Hundred Grains. Thus does Allah multiply reward for whomever He so wills. And Allah is All-Encompasing, All-Knowing. (Surah Al-Baqarah, 2:261)</p>
                    ...
                    <div class="contr-wrap text-center">
                        <div class="contr-inner">
                            <div class="contr-desc contr-inr">
                                ...
                                <p>MAKE MONTHLY CONTRIBUTION TO <br> NIGERIAN CANADIAN MUSLIMS EDMONTON. <br> <strong>ACCT # 8333-5271257 TD CANADA TRUST </strong> <br> AUTOMATIC INTERAC TRANSFER-EMAIL <strong>ncmedmonton@gmail.com</strong></p>
                            </div>
